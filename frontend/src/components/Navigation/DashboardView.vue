<template>
  ...
  <div class="d-flex flex-column flex-lg-row h-lg-full bg-surface-secondary" >
    <!-- Vertical Navbar -->
    <nav
      class="navbar show navbar-vertical h-lg-screen navbar-expand-lg px-0 py-3 navbar-light border-bottom border-bottom-lg-0 border-end-lg bg-gray-300"
      id="navbarVertical"
    >
              ...
              <div class="col-sm-6 col-12 text-sm-end">
                <div class="profile">
                  ...
                  <div class="profile-link" :class="{ show: isDropdownOpen }">
                    <router-link
                      @click="closeDropdown"
                      class="nav-link text-primary mt-0"
                      href="#"
                      :to="{ path: '/user_info' }"
