  ...
  <v-table elevation-6 fixed-header height="300px" class="mt-2 mb-10 table">
    ...
    <tbody>
      <tr v-for="user in filteredAttendanceMostAbsencData" :key="user.id">
        ...
        <td class="text-subtitle-1"> <v-avatar size="large">
        ...
        <td class="text-subtitle-1"> <v-btn color="teal-darken-4" :to="'/studentattendancedetail/' + user.id">
            Details<v-icon class="mt-1 ms-1">mdi-eye</v-icon></v-btn> </td>
      </tr>
    </tbody>
  </v-table>
</template>
