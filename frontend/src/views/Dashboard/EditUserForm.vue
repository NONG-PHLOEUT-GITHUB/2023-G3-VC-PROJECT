    ...
    <div class="card bg-gray-300">
      ...
      <form class="row g-3 card-body p-5 pt-4"  @submit.prevent="submitForm">
        ...
        <div class="col-md-6">
          ...
          <input type="date" class="form-control" v-model="user.date_of_birth" id="dateOfBirth" placeholder="" />
          <div class="valid-feedback">Looks good!</div>
        </div>
        <div class="col-md-6">
          <label for="validationCustom02" class="form-label">Age</label>
          <input type="number" class="form-control" id="dateOfBirth" v-model="user.age" placeholder="" />
          <div class="valid-feedback">Looks good!</div>
        </div>
        ...
        <div class="col-md-6">
          ...
          <div class="gender">
            ...
            <input type="radio" name="gender" id="female" value="female" v-model="user.gender" class="form-check-input ml-5" />
        ...
        <div class="col-12 d-flex justify-content-end">
          <router-link class="btn btn-warning text-white mr-2" :to="{ path: '/student'}">Cancel</router-link>
